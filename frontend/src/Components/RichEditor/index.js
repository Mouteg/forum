...
class RichEditor extends Component {
  ...
  render() {
    ...
    let saveButtonLabel = ''
    if (type === 'newOpinion') saveButtonLabel = t('editor.opinion.action')
    if (type === 'newDiscussion') saveButtonLabel = t('editor.discussion.action')

    let placeholder = ''
    if (type === 'newOpinion') placeholder = t('editor.opinion.placeholder')
    if (type === 'newDiscussion') placeholder = t('editor.discussion.placeholder')
